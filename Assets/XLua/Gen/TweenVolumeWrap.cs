...
namespace XLua.CSObjectWrap
{
    ...
    public class TweenVolumeWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(TweenVolume), L, translator, 0, 2, 4, 3);
			...
			Utils.EndObjectRegister(typeof(TweenVolume), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(TweenVolume), L, __CreateInstance, 2, 0, 0);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "Begin", _m_Begin_xlua_st_);
            
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(TweenVolume));
			
			
			Utils.EndClassRegister(typeof(TweenVolume), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					TweenVolume __cl_gen_ret = new TweenVolume();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to TweenVolume constructor!");
        ...
        static int _m_Begin_xlua_st_(RealStatePtr L)
        {
            ...
            try {
                
                {
                    ...
                    float targetVolume = (float)LuaAPI.lua_tonumber(L, 3);
                    
                        TweenVolume __cl_gen_ret = TweenVolume.Begin( go, duration, targetVolume );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_SetStartToCurrentValue(RealStatePtr L)
        {
            ...
            TweenVolume __cl_gen_to_be_invoked = (TweenVolume)translator.FastGetCSObj(L, 1);
