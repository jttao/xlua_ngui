...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTransformWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.Transform), L, translator, 0, 22, 17, 12);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "OverlayPosition", _m_OverlayPosition);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_OverlayPosition(RealStatePtr L)
        {
            ...
            try {
                if(__gen_param_count == 2&& translator.Assignable<UnityEngine.Transform>(L, 2)) 
                {
                    ...
                    __cl_gen_to_be_invoked.OverlayPosition( target );
                ...
                if(__gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& translator.Assignable<UnityEngine.Camera>(L, 3)) 
                {
                    ...
                    UnityEngine.Camera worldCam = (UnityEngine.Camera)translator.GetObject(L, 3, typeof(UnityEngine.Camera));
                    
                    __cl_gen_to_be_invoked.OverlayPosition( worldPos, worldCam );
                    
                    
                    
                    return 0;
                }
                if(__gen_param_count == 4&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& translator.Assignable<UnityEngine.Camera>(L, 3)&& translator.Assignable<UnityEngine.Camera>(L, 4)) 
                {
                    UnityEngine.Vector3 worldPos;translator.Get(L, 2, out worldPos);
                    UnityEngine.Camera worldCam = (UnityEngine.Camera)translator.GetObject(L, 3, typeof(UnityEngine.Camera));
                    UnityEngine.Camera myCam = (UnityEngine.Camera)translator.GetObject(L, 4, typeof(UnityEngine.Camera));
                    
                    __cl_gen_to_be_invoked.OverlayPosition( worldPos, worldCam, myCam );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.OverlayPosition!");
