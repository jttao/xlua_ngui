...
namespace XLua.CSObjectWrap
{
    ...
    public class TweenOrthoSizeWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(TweenOrthoSize), L, translator, 0, 2, 4, 3);
			...
			Utils.EndObjectRegister(typeof(TweenOrthoSize), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(TweenOrthoSize), L, __CreateInstance, 2, 0, 0);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "Begin", _m_Begin_xlua_st_);
            
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(TweenOrthoSize));
			
			
			Utils.EndClassRegister(typeof(TweenOrthoSize), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					TweenOrthoSize __cl_gen_ret = new TweenOrthoSize();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to TweenOrthoSize constructor!");
            ...
            try {
                
                {
                    ...
                    float to = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        TweenOrthoSize __cl_gen_ret = TweenOrthoSize.Begin( go, duration, to );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_SetStartToCurrentValue(RealStatePtr L)
        {
            ...
            TweenOrthoSize __cl_gen_to_be_invoked = (TweenOrthoSize)translator.FastGetCSObj(L, 1);
