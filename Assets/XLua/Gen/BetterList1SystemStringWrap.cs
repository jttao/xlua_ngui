...
namespace XLua.CSObjectWrap
{
    ...
    public class BetterList_1_SystemString_Wrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			Utils.BeginObjectRegister(typeof(BetterList<string>), L, translator, 0, 12, 2, 2);
			...
			Utils.EndObjectRegister(typeof(BetterList<string>), L, translator, __CSIndexer, __NewIndexer,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(BetterList<string>), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(BetterList<string>));
			
			
			Utils.EndClassRegister(typeof(BetterList<string>), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					BetterList<string> __cl_gen_ret = new BetterList<string>();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to BetterList<string> constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<BetterList<string>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					
					BetterList<string> __cl_gen_to_be_invoked = (BetterList<string>)translator.FastGetCSObj(L, 1);
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<BetterList<string>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING))
				{
        ...
        static int _m_GetEnumerator(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        System.Collections.Generic.IEnumerator<string> __cl_gen_ret = __cl_gen_to_be_invoked.GetEnumerator(  );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_Pop(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        string __cl_gen_ret = __cl_gen_to_be_invoked.Pop(  );
        ...
        static int _m_Sort(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    BetterList<string>.CompareFunc comparer = translator.GetDelegate<BetterList<string>.CompareFunc>(L, 2);
        ...
        static int _s_set_buffer(RealStatePtr L)
        {
            ...
            try {
                ...
                BetterList<string> __cl_gen_to_be_invoked = (BetterList<string>)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.buffer = (string[])translator.GetObject(L, 2, typeof(string[]));
