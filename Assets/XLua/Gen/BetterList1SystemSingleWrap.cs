...
namespace XLua.CSObjectWrap
{
    ...
    public class BetterList_1_SystemSingle_Wrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			Utils.BeginObjectRegister(typeof(BetterList<float>), L, translator, 0, 12, 2, 2);
			...
			Utils.EndObjectRegister(typeof(BetterList<float>), L, translator, __CSIndexer, __NewIndexer,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(BetterList<float>), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(BetterList<float>));
			
			
			Utils.EndClassRegister(typeof(BetterList<float>), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					BetterList<float> __cl_gen_ret = new BetterList<float>();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to BetterList<float> constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<BetterList<float>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					
					BetterList<float> __cl_gen_to_be_invoked = (BetterList<float>)translator.FastGetCSObj(L, 1);
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<BetterList<float>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3))
				{
        ...
        static int _m_GetEnumerator(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        System.Collections.Generic.IEnumerator<float> __cl_gen_ret = __cl_gen_to_be_invoked.GetEnumerator(  );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_Add(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    float item = (float)LuaAPI.lua_tonumber(L, 2);
        ...
        static int _m_Insert(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    int index = LuaAPI.xlua_tointeger(L, 2);
                    float item = (float)LuaAPI.lua_tonumber(L, 3);
        ...
        static int _m_Pop(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        float __cl_gen_ret = __cl_gen_to_be_invoked.Pop(  );
        ...
        static int _m_ToArray(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        float[] __cl_gen_ret = __cl_gen_to_be_invoked.ToArray(  );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_Sort(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    BetterList<float>.CompareFunc comparer = translator.GetDelegate<BetterList<float>.CompareFunc>(L, 2);
        ...
        static int _s_set_buffer(RealStatePtr L)
        {
            ...
            try {
                ...
                BetterList<float> __cl_gen_to_be_invoked = (BetterList<float>)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.buffer = (float[])translator.GetObject(L, 2, typeof(float[]));
