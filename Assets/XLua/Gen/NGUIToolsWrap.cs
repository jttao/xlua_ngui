...
namespace XLua.CSObjectWrap
{
    ...
    public class NGUIToolsWrap
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(typeof(NGUITools), L, __CreateInstance, 40, 4, 2);
            ...
            try {
                ...
                if(__gen_param_count == 2&& translator.Assignable<UnityEngine.GameObject>(L, 1)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    bool undo = LuaAPI.lua_toboolean(L, 2);
                        ...
                        UnityEngine.GameObject __cl_gen_ret = NGUITools.AddChild( parent, undo );
                        translator.Push(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 2&& translator.Assignable<UnityEngine.GameObject>(L, 1)&& translator.Assignable<UnityEngine.GameObject>(L, 2)) 
                {
                    ...
                    UnityEngine.GameObject prefab = (UnityEngine.GameObject)translator.GetObject(L, 2, typeof(UnityEngine.GameObject));
                        ...
                        UnityEngine.GameObject __cl_gen_ret = NGUITools.AddChild( parent, prefab );
                        translator.Push(L, __cl_gen_ret);
            ...
            try {
                
                {
                    ...
                    string spriteName = LuaAPI.lua_tostring(L, 3);
                        ...
                        UISprite __cl_gen_ret = NGUITools.AddSprite( go, atlas, spriteName );
                        translator.Push(L, __cl_gen_ret);
