...
namespace XLua.CSObjectWrap
{
    ...
    public class EventDelegateWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(EventDelegate), L, translator, 0, 6, 6, 3);
			...
			Utils.EndObjectRegister(typeof(EventDelegate), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(EventDelegate), L, __CreateInstance, 6, 0, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(EventDelegate));
			
			
			Utils.EndClassRegister(typeof(EventDelegate), L, translator);
        }
