...
namespace XLua.CSObjectWrap
{
    ...
    public class BetterList_1_SystemInt32_Wrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			Utils.BeginObjectRegister(typeof(BetterList<int>), L, translator, 0, 12, 2, 2);
			...
			Utils.EndObjectRegister(typeof(BetterList<int>), L, translator, __CSIndexer, __NewIndexer,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(BetterList<int>), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(BetterList<int>));
			
			
			Utils.EndClassRegister(typeof(BetterList<int>), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					BetterList<int> __cl_gen_ret = new BetterList<int>();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to BetterList<int> constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<BetterList<int>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					
					BetterList<int> __cl_gen_to_be_invoked = (BetterList<int>)translator.FastGetCSObj(L, 1);
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<BetterList<int>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3))
				{
        ...
        static int _m_GetEnumerator(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        System.Collections.Generic.IEnumerator<int> __cl_gen_ret = __cl_gen_to_be_invoked.GetEnumerator(  );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_Pop(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        int __cl_gen_ret = __cl_gen_to_be_invoked.Pop(  );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
        ...
        static int _m_Sort(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    BetterList<int>.CompareFunc comparer = translator.GetDelegate<BetterList<int>.CompareFunc>(L, 2);
        ...
        static int _s_set_buffer(RealStatePtr L)
        {
            ...
            try {
                ...
                BetterList<int> __cl_gen_to_be_invoked = (BetterList<int>)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.buffer = (int[])translator.GetObject(L, 2, typeof(int[]));
