...
namespace XLua.CSObjectWrap
{
    ...
    public class TweenWidthWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(TweenWidth), L, translator, 0, 2, 5, 4);
			...
			Utils.EndObjectRegister(typeof(TweenWidth), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(TweenWidth), L, __CreateInstance, 2, 0, 0);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "Begin", _m_Begin_xlua_st_);
            
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(TweenWidth));
			
			
			Utils.EndClassRegister(typeof(TweenWidth), L, translator);
        }
