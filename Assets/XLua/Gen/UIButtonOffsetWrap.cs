...
namespace XLua.CSObjectWrap
{
    ...
    public class UIButtonOffsetWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UIButtonOffset), L, translator, 0, 0, 4, 4);
			...
			Utils.EndObjectRegister(typeof(UIButtonOffset), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UIButtonOffset), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UIButtonOffset));
			
			
			Utils.EndClassRegister(typeof(UIButtonOffset), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UIButtonOffset __cl_gen_ret = new UIButtonOffset();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UIButtonOffset constructor!");
        ...
        static int _g_get_tweenTarget(RealStatePtr L)
        {
            ...
            try {
                ...
                UIButtonOffset __cl_gen_to_be_invoked = (UIButtonOffset)translator.FastGetCSObj(L, 1);
